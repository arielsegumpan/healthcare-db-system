<div>
    ...
    <div class="relative overflow-hidden">
        ...
        <div class="relative max-w-5xl mx-auto mt-10">
            <div class="w-full object-cover h-96 sm:h-120 bg-[url('https://plus.unsplash.com/premium_photo-1673953510197-0950d951c6d9?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-no-repeat bg-center bg-cover rounded-xl"></div>
        </div>
        </div>
    </div>
    <!-- End Hero -->
